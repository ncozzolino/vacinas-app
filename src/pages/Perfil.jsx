...
// (auth.currentUser.photoURL já vem pronta do login, sem custo nenhum).
// O código de upload (Storage + storage.rules) já existe no projeto,
// pronto pra ligar quando o Blaze for ativado.
